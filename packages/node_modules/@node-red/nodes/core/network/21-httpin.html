...
<script type="text/html" data-template-name="http in">
    ...
    <div class="form-row">
        <label for="node-input-monitor"><i class="fa fa-tag"></i> <span data-i18n="common.label.monitor">Monitor Req/Res</span></label>
        <input style="margin-left: -150px;" type="checkbox" id="node-input-monitor" data-i18n="[placeholder]common.label.monitor">
    </div>
